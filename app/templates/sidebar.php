...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
  <div class="navbar-header">
    <ul class="nav navbar-nav flex-row">
      <li class="nav-item mr-auto"><a class="navbar-brand" href="html/ltr/vertical-menu-template-semi-dark/index.html">
          ...
          <h2 class="brand-text mb-0">Poliklinikk</h2>
        </a></li>
  ...
  <div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
      ...
      <li class="<?php echo is_active('poli'); ?> nav-item">
        <a href="?page=poli">
          <i class="feather icon-user"></i><span class="menu-title" data-i18n="poli">Poli</span>
        </a>
      </li>
